          ...
          <ScrollReveal direction="right">
            <div className="bg-white rounded-xl border border-border p-8 h-full flex flex-col">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-accent text-white font-semibold rounded-lg text-base transition-all duration-200 ease-out hover:scale-[1.01] hover:shadow-lg hover:shadow-accent/25 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
                >
                  Send Request
                </button>
